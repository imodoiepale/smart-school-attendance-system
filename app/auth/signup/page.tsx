    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 sm:px-8 py-12">
        <div className="w-full max-w-md">
          {/* Header */}
          <div className="mb-8">
            <h2 className="text-sm text-gray-600 tracking-wide mb-2">Get Started</h2>
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Create Your Account</h1>
            <p className="text-gray-600 text-base">Enter your details to access SmartSchool Sentinel</p>
          </div>
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.role} onValueChange={(value) => setFormData({ ...formData, role: value })}>
                <SelectTrigger className="h-12 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="senior_master">Senior Master</SelectItem>
            ...
            <label className="flex items-start space-x-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 border border-gray-300 rounded mt-0.5"
              />
      ...
      <div className="hidden lg:flex w-1/2 bg-gray-100 relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
          ...
          <p className="text-gray-100 text-sm leading-relaxed">
            Join thousands of schools using our intelligent attendance and safety management system
          </p>
        </div>
      </div>
    </div>
